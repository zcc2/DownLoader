...
public class DownListActivity extends BaseActivity {
    ...
    protected void findView() {
        ...
        recyclerView.addItemDecoration(new SimpleDividerItemDecoration(activity, DisplayUtil.dip2px(2)));
        adapter = new DownloadAdapter(activity, dowmList);
                    ...
                    if (!file.exists() && tvLook.getText().toString().equals("下载")) {
                        ...
                        try {
                            ...
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                                ...
                                Uri contentUri = FileProvider.getUriForFile(activity, Constant.FILE_PROVIDER, file);
